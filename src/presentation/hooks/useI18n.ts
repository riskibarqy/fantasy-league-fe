...
const MESSAGES: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "fixtures.pagination.summary": "Page {page} of {totalPages}",
    "fixtures.pagination.total": "{total} fixtures",
  ...
  id: {
    ...
    "fixtures.pagination.summary": "Halaman {page} dari {totalPages}",
    "fixtures.pagination.total": "{total} pertandingan",
    "fixtures.mode.live": "Live",
